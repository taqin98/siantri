...
include './component/config.php';
 ...
 $sql = "SELECT * from pasien NATURAL JOIN klinik NATURAL JOIN dokter
 		 WHERE no_rm IN (SELECT MAX(no_rm) from pasien)";
...
<div id="print-area-2" class="print-area">
	...
	<table border="1" style="font-family: Arial;">
		...
		<tr>
			<td rowspan="2">Nomor Antrian Anda</td>
			<td rowspan="2">:</td>
			<td colspan="2" rowspan="2">
				<h4>
					<b style="background: #ff9800; border-radius: 25px; padding: 4px;"><?php echo $data['id_antrian']; ?></b>
				</h4>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="3">Silahkan Datang 15 Menit Sebelum Pemeriksaan</td>
		</tr>
