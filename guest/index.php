...
if(!isset($_SESSION['guest'])){
    echo '<script language="javascript">alert("Anda harus Login! sebagai User"); document.location="../index.php";</script>';
}
?>
                                            ...
                                            <ul class="nav nav-tabs" >
                                                <li class="nav-item">
                                                    <a class="nav-link" href="?halaman=home" >
                                                        <i class="material-icons">face</i> <?php echo $_SESSION['guest']; ?>
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="?halaman=history" >
                                                        <i class="material-icons">chat</i> Histori
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                </li>
                                                
                                                <li class="nav-item">
                                                    <a class="nav-link" href="?halaman=print" >
                                                        <i class="material-icons">chat</i> Cetak
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <?php
                                            error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                                                ...
                                                switch ($_GET['halaman']) 
                                                {
                                                    ...
                                                    case 'home':
                                                        # code...
                                                        include 'view/home_guest.php';
                                                        break;

                                                    case 'print':
                                                        # code...
                                                        include 'view/print_antrian.php';
                                                        break;

                                                    case 'hapus':
                                                        # code...
                                                        include 'view/hapus_data.php';
                                                        break;
                                                    ...
                                                    case 'history':
                                                        # code...
                                                        include 'view/history_guest.php';
                                                        break;
